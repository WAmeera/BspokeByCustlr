  ...
  else
{
  if (
    (this.state.value == "All"
              ? this.state.dataSource.filter(items => (items.category == "Slim Fit")).length
              : this.state.value == "Top Seller"
              ? this.state.dataSource.filter(items => (items.category == "Slim Fit") && (items.Status == "Top Seller")).length
              : this.state.value == "Featured"
              ? this.state.dataSource.filter(items => ((items.category == "Slim Fit") && (items.Status == "Featured"))).length
              : this.state.value == "Latest"
              ? this.state.dataSource.filter(items => ((items.category == "Slim Fit") && (items.Status == "New Arrival"))).length
              : this.state.value == "RM0 - RM100"
              ? this.state.dataSource.filter(items => ((items.category == "Slim Fit") && (items.Price <= 100))).length
              : this.state.value == "RM100 - RM200"
              ? this.state.dataSource.filter(items => ((items.category == "Slim Fit") && ((items.Price >= 100) && (items.Price <= 200)))).length
              : this.state.value == "Above RM200"
              ? this.state.dataSource.filter(items => ((items.category == "Slim Fit") && (items.Price >= 200))).length
              : this.state.dataSource.filter(items => (items.category == "Slim Fit")).length)
        != 0
