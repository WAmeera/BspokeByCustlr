...
export default class muscle100to200 extends React.Component {
...
componentWillMount (){
 ...
 render() {
    ...
    <View style={styles.container}>     
        <FlatList
            numColumns={2}
           data = {this.state.dataSource.filter(items => ((items.category == "Muscle Fit") && ((items.Price >= 100) && (items.Price <= 200))))}
