...
export default class normaltopseller extends React.Component {
...
componentWillMount (){
 ...
 render() {
    ...
    <View style={styles.container}>     
        <FlatList
            numColumns={2}
           data = {this.state.dataSource.filter(items => ((items.category == "Regular Fit") && (items.Status == "Top Seller")))}
